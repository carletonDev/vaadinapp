...
@ServerClass("com.onshoreoutsourcing.carleton.ui.views.orderedit.OrderEditViewDesign")
@AutoGenerated
public class OrderEditViewDesignElement extends VerticalLayoutElement {
	...
	public OrderHistoryElement getHistory() {
		return $(com.onshoreoutsourcing.carleton.ui.views.orderedit.OrderHistoryElement.class).id("history");
	}
